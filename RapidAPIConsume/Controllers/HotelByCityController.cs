...
{
    public class HotelByCityController : Controller
    {
        public async Task<IActionResult> Index(string destId)
        {
            if (!string.IsNullOrEmpty(destId))
            {
                ...
                var request = new HttpRequestMessage
                {
                    ...
                    RequestUri = new Uri($"https://booking-com.p.rapidapi.com/v2/hotels/search?children_number=2&adults_number=2&categories_filter_ids=class%3A%3A2%2Cclass%3A%3A4%2Cfree_cancellation%3A%3A1&children_ages=5%2C0&checkout_date=2026-03-27&dest_type=city&page_number=0&units=metric&order_by=popularity&room_number=1&checkin_date=2026-03-24&filter_by_currency=EUR&dest_id={destId}&locale=en-gb&include_adjacency=true"),
                    Headers =
    {
